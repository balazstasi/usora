...
export function TransactionCard({
  ...
  const progress =
    ((transaction.totalAmount - transaction.remainingAmount) /
  ...
  const isOverdue =
    isBefore(transaction.nextPaymentDate, new Date()) &&
    transaction.status === "active";
  const isDueSoon =
    isAfter(transaction.nextPaymentDate, new Date()) &&
    isBefore(transaction.nextPaymentDate, addDays(new Date(), 7));
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm text-muted-foreground">
            <span>
              $
              {(transaction.totalAmount - transaction.remainingAmount).toFixed(
                2
              )}{" "}
              paid
            </span>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold">
                  ${transaction.nextPaymentAmount.toFixed(2)}
                </p>
                <p
